    ...
    public void onClickListener() {
            switch(button.getId()) {
                ...
                case R.id.buttonIntent2:
                    Toast.makeText(IntentActivity.this, "button2", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.buttonIntent3:
                    Toast.makeText(IntentActivity.this, "button3", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
